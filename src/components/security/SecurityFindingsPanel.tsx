...
> = {
  critical: {
    ...
    sectionBg: 'bg-red-50 text-red-700 dark:bg-red-950/40 dark:text-red-400',
  ...
  warning: {
    ...
    sectionBg: 'bg-amber-50 text-amber-700 dark:bg-amber-950/40 dark:text-amber-400',
    sectionText: 'Warning',
  },
  info: {
    icon: Info,
    ...
    sectionBg: 'bg-indigo-50 text-indigo-700 dark:bg-indigo-950/40 dark:text-indigo-400',
    sectionText: 'Info',
  },
};
